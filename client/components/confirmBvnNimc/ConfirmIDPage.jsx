...
import ConfirmIDSideMenu from './ConfirmIDSideMenu.jsx';
import ConfirmIDForm from './ConfirmIDForm.jsx';
import getWalletBalanceRequest from '../../actions/walletActions/getWalletBalance'


class ConfirmIDPage extends React.Component {
  componentDidMount() {
  ...
  render() {
      ...
      <div>
        ...
        <section id="breadcrumb">
          <div class="container">
            <ol class="breadcrumb">
              <li>
                <Link to="#">Confirm User Dashboard</Link>
              </li>
            </ol>
          </div>
        </section>
    ...
    return <div>{confirmIdContainer}</div>;
  }
}

ConfirmIDPage.propTypes = {
